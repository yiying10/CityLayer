...
<p align="center">
  <img src="assets/pipeline.png" width="360" alt="Citylayer pipeline: depth-guided layering and per-layer inpainting to build layered 3DGS models (Model Synthesis), then feature matching, similarity-transform estimation, trajectory planning, and scene fusion to connect two scenes (Scene Interconnection).">
</p>
